  ...
  (/MSIE ([6789]|10)/.test(navigator.userAgent) ||
    ...
    (window.__twttr && window.__twttr.widgets && window.__twttr.widgets.init) ||
      (function(t) {
                ...
                return (
                  ...
                  m.length !== t.length || 0 === v.length
                    ? (l &&
                      ...
                      r.reject(
                        new Error("Not enough parameters. Expected: " + d)
                      ))
                    : h
                    ? ((f = c.aug({}, f || {}, e)),
                      ...
                      (p = a.getExperiments().then(function(t) {
                        return o.addWidget(
                          n(f, h, void 0, s.isHorizonTweetEnabled(t))
                        );
                      })),
                      l &&
                        p.then(l, function() {
                    ...
                    : (l &&
                      ...
                      r.reject(
                        new Error("No target element specified. Expected: " + d)
                      ))
                );
              }
            );
        ...
        function(t, e, n) {
          ...
          t.exports = {
            ...
            canPostMessage: function(t, e) {
              return (
                (t = t || s), (e = e || u), t.postMessage && !(c(e) && t.opener)
              );
            },
            ...
            hasLocalStorageSupport: function() {
              try {
                ...
                return (
                  i.devError("window.localStorage is not supported:", t), !1
                );
              }
            }
          };
          ...
          t.exports = function(t) {
            t.params({
              ...
              t.define("fetch", function() {
                return i
                  .fetch(this.endpoint, this.queryParams(), o, this.cbId())
                  .then(h, p);
              }),
        ...
        function(t, e, n) {
          ...
          t.exports = {
            ...
            formatTweetAssociation: function(t, e) {
              var n = {};
              return (
                ((e = e || {}).association_namespace = p(t)), (n[h] = e), n
              );
            },
        ...
        function(t, e, n) {
          ...
          t.exports = {
            ...
            stopImmediatePropagation: function(t) {
              t &&
                ((t.ceaseImmediately = !0), f(t), t.stopImmediatePropagation());
            },
            preventDefault: l,
        ...
        function(t) {
          t.exports = { version: "3541749:1571780739496" };
        },
        function(t, e, n) {
          var r,
            i = n(10),
          ...
          t.exports = function(t, e, n, d) {
            ...
            return d
              ? ((l = i.createElement("div")),
                new r(s, o, c.TWEET, t, e, n, { sandboxWrapperEl: l }))
        ...
        function(t) {
          t.exports = {
            tweetButtonHtmlPath:
              "/widgets/tweet_button.2d991e3dfc9abb2549972ce8b64c5d85.{{lang}}.html",
            followButtonHtmlPath:
              "/widgets/follow_button.2d991e3dfc9abb2549972ce8b64c5d85.{{lang}}.html",
            hubHtmlPath: "/widgets/hub.html",
            widgetIframeHtmlPath:
              "/widgets/widget_iframe.2d991e3dfc9abb2549972ce8b64c5d85.html",
        ...
        function(t, e, n) {
          ...
          (o.prototype.assert = function(t, e) {
            ...
            (o.prototype.require = function(t) {
              var e = this;
              return (
                (t = Array.isArray(t) ? t : i.toRealArray(arguments)).forEach(
                  function(t) {
                    e.assert(
                      (function(t) {
                        return function(e) {
              ...
              (n = s
                ...
                .then(function(t) {
                  l.trigger("loaded", { widgets: t }),
                    t &&
                      t.length &&
                      v.emitter.trigger(v.ALL_WIDGETS_RENDER_END, {
                        widgets: t
                      });
                })),
              s.always(n, function() {
            ...
            (c.prototype.fail = function() {
              ...
              return this._srcEl
                ? u.always(
                    ...
                    function() {
                      o.trigger("rendered", { target: t._srcEl }),
                        t._resolve(t._srcEl);
                    }
                  )
        ...
        function(t, e, n) {
          ...
          function S(t, e, n, r) {
            return (
              (e = v.aug({ id: t }, b, e)), (n = v.aug({}, _, n)), l(e, n, r)
            );
          }
              ...
              t.define("addCss", function(t, e) {
                ...
                return c.inlineStyle()
                  ? (((n = this.createElement("style")).type = "text/css"),
                    ...
                    o.write(y(e, null, n)))
                  : (f.devError("CSP enabled; cannot embed inline styles"),
                    m.resolve());
              }),
            ...
            load: function() {
              ...
              (t = { origin: l.origin }),
                ...
                (n = function(t) {
                  var n;
                  if (
                    e.substr(0, t.origin.length) === t.origin &&
                    w.isTwitterURL(t.origin)
                  )
                    try {
                      (n = "string" == typeof t.data ? d.parse(t.data) : t.data)
                        .namespace === h.settings &&
                        ((r = E(n.settings)), _().resolve());
                    } catch (t) {
                      f.devError(t);
                    }
                }),
            ...
            t.defineStatic("isSupported", function() {
              ...
              t.define("_updateCachedDimensions", function() {
                ...
                return a.read(function() {
                  ...
                  "visible" == t.sandboxEl.style.visibility
                    ? (t._width = n.width)
                    : ((e = f(t.sandboxEl.parentElement).width),
                      (t._width = Math.min(n.width, e))),
                    (t._height = n.height);
                });
              }),
          ...
          /^loade|c/.test(s.readyState) && (u = 1),
            ...
            d.doScroll &&
              s.attachEvent(
                ...
                (r = function() {
                  /^c/.test(s.readyState) &&
                    (s.detachEvent("onreadystatechange", r), l());
                })
              ),
            (o = d.doScroll
              ? function(t) {
