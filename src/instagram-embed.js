(function() {
  ...
  __d(
    function(g, r, i, a, m, e, d) {
      ...
      function b(t) {
        P.hasOwnProperty(t) && (delete P[t], y());
      }
      function h(t) {
        ...
        switch (p) {
          case i(d[0]).MOUNTED: {
            ...
            if (
              (t || i(d[1])(0),
              (w = t.clientHeight),
              (o.style.position = o.hasAttribute(v) ? o.getAttribute(v) : ""),
              ...
              f(function(t) {
                K[c] &&
                  ...
                  window.__igEmbedLoaded &&
                    window.__igEmbedLoaded({ frameId: c, stats: K[c] }));
              });
            break;
          }
          case i(d[0]).LOADING:
      ...
      const A = "data-instgrm-captioned",
        ...
        _ = new RegExp(
          "^(" + B.source.replace(/^\^/, "").replace(/\$$/, "") + "/p/[^/]+)"
        ),
        v = "data-instgrm-preserve-position",
        G = new RegExp(
          "^(" + B.source.replace(/^\^/, "").replace(/\$$/, "") + "/embed\\.js)"
        ),
