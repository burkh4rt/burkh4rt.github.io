                  ...
                  <ul className="pubslist">
                    ...
                    <li>
                      ...
                      <Link
                        ...
                        inline={true}
                      >
                        Prototype learning to create refined interpretable
                        digital phenotypes from ECGs
                      </Link>
                      , Pacific Symposium on Biocomputing 31 (2026)&ensp;&ensp;
                      <Link
                    ...
                    <li>
                      ...
                      <Link
                        ...
                        inline={true}
                      >
                        Diagnostic codes in AI prediction models and label
                    ...
                    <li>
                      S. Sethi, D. Chen, T. Statchen, M. Burkhart, N. Bhandari,
                      B. Ramadan, &amp; B. Beaulieu-Jones,{" "}
                      <Link
                    ...
                    <li>
                      M. Burkhart, L. Lee, D. Vaghari, A. Toh, E. Chong, C.
                      Chen, P. Tiňo, &amp; Z. Kourtzi,{" "}
                      <Link
                    ...
                    <li>
                      L. Lee, D. Vaghari, M. Burkhart, P. Tiňo, M. Montagnese,
                      Z. Li, K. Zühlsdorff, J. Giorgio, G. Williams, E. Chong,
                      C. Chen, B. Underwood, T. Rittman, &amp; Z. Kourtzi,{" "}
                      <Link
                ...
                <Text>
                  <ul className="pubslist">
                    <li>
                      ...
                      including M. Burkhart, D. Brandman, E. Brown, & M.
                      Harrison), J. Donoghue, J. Simeral, L. Hochberg, & F.
                      Willett,{" "}
                      <Link
                        ...
                        inline={true}
                      >
                        Long-term performance of intracortical microelectrode
                        arrays in 14 BrainGate clinical trial participants
                      </Link>
                    ...
                    <li>
                      M. Burkhart, B. Ramadan, Z. Liao, K. Chhikara, J. Rojas,
                      W. Parker, &amp; B. Beaulieu-Jones,{" "}
                      <Link
                ...
                <Text>
                  <ul className="pubslist">
                    <li>
                      ...
                      , Ph.D. Dissertation, Division of Applied Mathematics,
                      Brown University, Providence, 2019&ensp;&ensp;
                      <Link
                  ...
                  <ul className="pubslist">
                    <li>
                      ...
                      , U.S. Patent Application #17/748,891 filed 2022,
                      published 2023&ensp;&ensp;
                      <Link
