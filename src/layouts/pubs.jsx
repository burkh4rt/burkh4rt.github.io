    ...
    <SplitPageLayout padding="normal" className="page">
      <SplitPageLayout.Header>
        <Breadcrumbs>
          ...
          <Breadcrumbs.Item selected>publications</Breadcrumbs.Item>
        </Breadcrumbs>
      </SplitPageLayout.Header>
          ...
          <ul className="pubslist">
            <li>
              ...
              >
                ...
                informative events in electronic health records with foundation
                models
              </Link>
            ...
            <li>
              ...
              <Link
                ...
                inline={true}
              >
                Synthetic data distillation enables the extraction of clinical
            ...
            <li>
              L. Lee, D. Vaghari, M. Burkhart, P. Tiňo, M. Montagnese, Z. Li, K.
              Zühlsdorff, J. Giorgio, G. Williams, E. Chong, C. Chen, B.
              Underwood, T. Rittman, &amp; Z. Kourtzi,{" "}
              <Link
            ...
            <li>
              R. Li, E. Harshfield, S. Bell, M. Burkhart, A. Tuladhar, &hellip;,
              C. Chen, Z. Kourtzi, &amp; H. Markus,{" "}
              <Link
                ...
                inline={true}
              >
                Predicting incident dementia in cerebral small vessel disease:
                comparison of machine learning and traditional statistical
                models
              </Link>
            ...
            <li>
              ...
              Bruffaerts, M. Burkhart, I. Dewachter, &hellip;, D. Llewellyn, M.
              Veldsman, &amp; T. Rittman,{" "}
              <Link
            ...
            <li>
              ...
              <Link
                ...
                inline={true}
              >
                Conjugacy conditions for supersoluble complements of an abelian
                base and a fixed point result for non-coprime actions
              </Link>
            ...
            <li>
              ...
              Ciancibello, &hellip;, M. Harrison, J. Simeral, &amp; L. Hochberg,{" "}
              <Link
                ...
                inline={true}
              >
                Rapid calibration of an intracortical brain computer interface
            ...
            <li>
              ...
              <Link
                ...
                inline={true}
              >
                Measurement and verification of building systems under uncertain
                data: a Gaussian process modeling approach
              </Link>
          ...
          <ul className="pubslist">
            <li>
              ...
              <Link
                ...
                inline={true}
              >
                Long-term performance of intracortical microelectrode arrays in
                14 BrainGate clinical trial participants
              </Link>
            ...
            <li>
              ...
              <Link
                ...
                inline={true}
              >
                Foundation models for electronic health records: representation
            ...
            <li>
              M. Abroshan, M. Burkhart, O. Giles, S. Greenbury, Z. Kourtzi, J.
              Roberts, M. van der Schaar, J. Steyn, A. Wilson, &amp; M. Yong,{" "}
              <Link
                ...
                inline={true}
              >
                Safe AI for health and beyond &ndash; monitoring to transform a
                health service
              </Link>
          ...
          <ul className="pubslist">
            ...
            <li>
              ...
              <Link
                ...
                inline={true}
              >
                Digital experience enhancement using an ensemble deep learning
                model
              </Link>
