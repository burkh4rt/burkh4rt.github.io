...
import {MortarBoardIcon, GitCommitIcon, LocationIcon} from '@primer/octicons-react'
                  ...
                  <SubNav aria-label="Main">
                    <SubNav.Links>
                      ...
                      <SubNav.Link href="https://scholar.google.com/citations?user=OcFnA0UAAAAJ" target="_blank">
                        <img src={GoogleScholarLogo} alt="Google Scholar" height="20px" />
                      </SubNav.Link>
                      ...
                      <SubNav.Link href="https://www.inaturalist.org/people/burkh4rt" target="_blank">
                        <img src={INaturalistLogo} alt="iNaturalist" height="20px" />
                      </SubNav.Link>
                    </SubNav.Links>
                  </SubNav>
                </Box>
                ...
                <Timeline style={{maxWidth: `calc(max(75%,500px))`}}>
                  <Timeline.Item>
                    ...
                    <Timeline.Body sx={{fontSize: `1rem`}}>
                      ...
                      <Link href="https://doi.org/10.26300/nhfp-xv22">dissertation</Link>, I derived a novel approach to
                      Bayesian filtering, the Discriminative Kalman Filter, motivated by and developed with my advisor
                      M. Harrison and collaborators D. Brandman and L. Hochberg. We validated and successfully
                      implemented this filter as part of the <Link href="https://www.braingate.org">BrainGate</Link>{' '}
                  ...
                  <Timeline.Item>
                    ...
                    <Timeline.Body sx={{fontSize: `1rem`}}>
                      I then spent three years working as a machine learning scientist at Adobe in California. In 2021,
                      I joined Cambridge University as a research associate to develop machine learning-based approaches
                      for the early diagnosis of neurodegenerative disease.
                    </Timeline.Body>
                  </Timeline.Item>
                </Timeline>
